...
from linkshield.models.project import Project, ProjectMember, MonitoringConfig, ProjectAlert, ProjectRole, AlertInstance, AlertType, AlertChannel
from linkshield.models.subscription import SubscriptionPlan, UserSubscription
from linkshield.models.user import User
from linkshield.models.activity_log import ActivityLog, ActivityLogManager
from linkshield.services.email_service import EmailService, EmailRequest
from linkshield.services.security_service import SecurityService
from linkshield.services.advanced_rate_limiter import rate_limit
from linkshield.authentication.auth_service import AuthService
from linkshield.utils import utc_datetime
from linkshield.config import settings
...
class DashboardController(BaseController):
    ...
    async def get_social_protection_overview(
        ...
        *,
        ...
        try:
            async with self.get_db_session() as session:
                from linkshield.models.social_protection import SocialProfileScan, ContentRiskAssessment
    ...
    async def get_protection_health(
        ...
        *,
        ...
        try:
            async with self.get_db_session() as session:
                from linkshield.models.social_protection import SocialProfileScan, ContentRiskAssessment
                from linkshield.models.url_check import URLCheck
