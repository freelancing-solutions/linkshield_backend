...
from linkshield.models.email import EmailRequest, EmailType
from linkshield.models.user import User, UserSession, APIKey, PasswordResetToken, EmailVerificationToken
...
from linkshield.services.session_manager import SessionManager
from linkshield.services.content_analyzer import ContentAnalyzerService
from linkshield.services.algorithm_health import AlgorithmHealthService
from linkshield.social_protection.types import PlatformType, RiskLevel
from linkshield.social_protection.controllers.social_protection_controller import SocialProtectionController
...
class UserController(BaseController):
    ...
    async def get_user_protection_settings(self, *, user: User) -> Dict[str, Any]:
        ...
        try:
            async with self.get_db_session() as session:
                ...
                from linkshield.models.social_protection import SocialProfileScan
    ...
    async def get_user_protection_analytics(self, *, user: User) -> Dict[str, Any]:
        ...
        try:
            async with self.get_db_session() as session:
                from linkshield.models.social_protection import SocialProfileScan, ContentAssessment
