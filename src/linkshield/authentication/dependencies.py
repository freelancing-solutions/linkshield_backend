...
from linkshield.authentication.auth_service import AuthService, AuthenticationError
...
from linkshield.auth.bot_auth import verify_webhook_signature, verify_api_key
...
async def get_admin_user(
    ...
    """
    from linkshield.models.user import UserRole
...
async def _validate_user_session_in_db(db: AsyncSession, session_id: str, user_id: str) -> tuple[bool, Optional]:
    ...
    """
    from sqlalchemy import select
    from linkshield.models.user import UserSession
