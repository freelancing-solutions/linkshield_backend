...
from linkshield.models.bot import BotUser, get_or_create_bot_user
from linkshield.models.social_protection import PlatformType, RiskLevel
...
class SocialMediaBotService:
    ...
    async def _log_analysis_request(
        ...
        try:
            ...
            from linkshield.models.social_media_bot import BotAnalysisLog
