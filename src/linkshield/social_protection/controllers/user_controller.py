...
from linkshield.models.project import Project
...
from linkshield.social_protection.types import PlatformType, RiskLevel, ScanStatus
from linkshield.social_protection.data_models import ContentRiskAssessment, ContentType
from linkshield.social_protection.services import SocialScanService
...
class UserController(BaseController):
    ...
    async def _get_user_recent_scans(
        ...
        try:
            ...
            from linkshield.models.social_protection import SocialProfileScanORM
