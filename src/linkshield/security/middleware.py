...
# from linkshield.services.advanced_rate_limiter import get_rate_limiter, AdvancedRateLimiter
...
class RateLimitMiddleware(BaseHTTPMiddleware):
        ...
        try:
            ...
            if "not fully defined" in msg or "ForwardRef" in msg:
                try:
                    ...
                    from linkshield.controllers import dashboard_models
    ...
    def _determine_limit_scope(self, request: Request):
        ...
        """
        from linkshield.services.advanced_rate_limiter import RateLimitScope
