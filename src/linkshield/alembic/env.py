...
from linkshield.models import user, url_check, report, subscription, ai_analysis, social_protection  # noqa: F401
from linkshield.config.database import Base   # <- single Base you used in metadata
