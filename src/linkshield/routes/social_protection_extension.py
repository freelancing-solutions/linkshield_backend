...
from linkshield.social_protection.controllers.extension_controller import (
    ExtensionController,
    ExtensionEventType,
    ExtensionAnalysisMode,
    ExtensionResponseType
)
from linkshield.social_protection.controllers.depends import get_extension_controller
