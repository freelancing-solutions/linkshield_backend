...
from linkshield.controllers.depends import get_ai_analysis_controller
from linkshield.controllers import AIAnalysisController
from linkshield.models.ai_analysis import AnalysisType
